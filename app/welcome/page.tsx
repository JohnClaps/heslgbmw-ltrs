...
export default function WelcomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Advanced security measures with complete transparency in all transactions",
    },
    {
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <Image src="/logo.png" alt="Student-LTRS Logo" width={50} height={50} className="rounded-full" />
              <div>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed animate-slide-up">
              Student-LTRS revolutionizes educational financing by connecting students, institutions, employers, and
            ...
            {demoUsers.map((user, index) => (
              ...
              >
                ...
                <CardContent>
                  ...
                  >
                    {activeDemo === user.email ? "Loading..." : "Try Demo"}
                  </Button>
                </CardContent>
              </Card>
            ))}
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="border rounded-lg px-6 animate-fade-in">
              <AccordionTrigger className="text-left">
                How does Student-LTRS help students manage their loans?
              </AccordionTrigger>
              <AccordionContent className="text-gray-600">
                Student-LTRS provides a comprehensive dashboard where students can view all their loans, track payment
                schedules, make payments, and monitor their repayment progress. The platform also offers insights and
            ...
            >
              ...
              <AccordionContent className="text-gray-600">
                Yes, we employ industry-standard security measures including encryption, secure authentication, and
                regular security audits. All financial data is protected and we comply with relevant data protection
                regulations.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="text-gray-600">
                Student-LTRS is specifically designed for educational loans with features like multi-stakeholder
                support, transparent tracking, employer sponsorship programs, and institution integration. Our platform
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-orange-500 to-blue-600">
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto text-white">
            <h2 className="text-3xl font-bold mb-4 animate-fade-in">Ready to Transform Your Education Financing?</h2>
            <p className="text-xl mb-8 opacity-90 animate-slide-up">
              Join thousands of students, institutions, and employers who trust Student-LTRS for their educational loan
              management needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up">
              <Button
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                <Image src="/logo.png" alt="Student-LTRS Logo" width={40} height={40} className="rounded-full" />
                <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Student-LTRS. All rights reserved. Built with ❤️ for students worldwide.</p>
          </div>
        </div>
      </footer>
